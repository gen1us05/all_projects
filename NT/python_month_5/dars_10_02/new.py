...
d = {'content_type': 'text',
     ...
     'from_user':
         {'id': 1498039503,
          'is_bot': False,
          'first_name': 'Jamshidbek',
          'username': 'Developer_n_1',
          'last_name': None,
          'language_code': 'en',
     ...
     'date': 1708401227,
     'chat': {'id': 1498039503, 'type': 'private', 'title': None, 'username': 'Developer_n_1',
              'first_name': 'Jamshidbek', 'last_name': None, 'is_forum': None, 'photo': None, 'bio': None,
              ...
              'emoji_status_expiration_date': None, 'available_reactions': None, 'accent_color_id': None,
     ...
     'media_group_id': None, 'author_signature': None, 'text': 'salom', 'entities': None, 'caption_entities': None,
     'audio': None, 'document': None, 'photo': None, 'sticker': None, 'video': None, 'video_note': None, 'voice': None,
     'caption': None, 'contact': None, 'location': None, 'venue': None, 'animation': None, 'dice': None,
     ...
     'reply_to_story': None,
     'json': {'message_id': 28,
                  'from': {'id': 1498039503, 'is_bot': False, 'first_name': 'Jamshidbek',
                           'username': 'Developer_n_1', 'language_code': 'en'},
                  'chat': {'id': 1498039503, 'first_name': 'Jamshidbek',
                           'username': 'Developer_n_1', 'type': 'private'},
                  'date': 1708401227,
                  'text': 'salom'}}
